...
#tim-container {width:100%;margin:0;padding:0}
...
#modal-home {margin-top:-100px;z-index:999999999999999999999999999999}

#mega-menu-wrap-footer-1 {border-top:1px solid #00a4e4;margin-top:-5px}
...
.box-it, .creditos, .box-sz1 h2, .box-sz2 h2 {font-family: 'TIMSansWeb', Fallback, times-new-roman}
...
.bar-primary, .bar-secundary {padding-left:10px;width:320px}
.fa-search {margin-top:20px}
#footer-tim {width:100%;background-color: #004691;margin-top:200px;height:550px;color:#89c3ff}
.footer-tim {width:300px;margin:0 auto;height:300px;font-size:10pt;padding:10px;background-color: #004691}
.creditos {width:300px;height:50px;text-align:center;color:#89c3ff;font-size:9pt;clear:both;margin-top:200px}
.footer-tim a {color:#fff}
...
#tim-container {background-color: #004691}
#footer-tim {width:100%;background-color: #004691;margin-top:200px;height:775px;color:#89c3ff}
.box-sz2 p {margin-top:5px}
.container-2 {width:360px}
.box-it {float:none;padding:20px}
.box-sz1 {width:320px}
.nav-f {display:block;width:340px;z-index:99999;position:relative}
...
.creditos {width:340px;height:100px;text-align:center;color:#89c3ff;font-size:9pt;clear:both;margin-top:130px}
.box-sz2 h2 {padding-top:10px}
.box-it li a {color:#fff}
.footerborder-left {}
.nav-e {padding-bottom:10px}
...
.bar-secundary {height:148px}

.nav-f {width:620px;float:left;padding-left:70px;display:block}
...
.nav-e {width:350px;float:left;padding-bottom:0}
}
...
<div id="tim-container">
	...
	<div class="menu-it">
		<div class="container-2 bar-secundary">
			...
			<div class="tfc" style="height:35px">
				<a href="<?php echo get_option('home'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/imagens/logo_timtec.png" alt="" title="" /></a>
			</div>
                                        ...
                                        <div class="nav-e">
                                                    <div class="search2">
                                                            <form role="search" method="get" action="<?php echo home_url( '/' ); ?>">
                                                                    <input type="search" class="search" placeholder="O que você procura?" value="" name="s" title="O que você procura?" />
